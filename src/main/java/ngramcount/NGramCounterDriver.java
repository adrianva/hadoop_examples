 ...
 */
public class NGramCounterDriver extends Configured implements Tool {
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(NGramCounterDriver.class);
        // diput ata format
    ...
    public static void main(String[] args) throws Exception {
        ...
        int res = ToolRunner.run(new NGramCounterDriver(), args);
